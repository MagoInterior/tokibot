...
const _sewa = require("./armor/js/sewa");

const premium = require("./armor/js/premium");
...
let sewa = JSON.parse(fs.readFileSync('./sewa.json'));
//\\
...
const _premium = JSON.parse(fs.readFileSync('./datab/usuarios/premium.json'));
